...
-- 2. Xóa các bảng cũ nếu đã có (theo thứ tự khóa ngoại)
...
-- ============================================================
-- NẠP 100% DỮ LIỆU MẪU ĐỒNG BỘ (MẬT KHẨU: 123456)
-- ============================================================
...
-- Tài khoản người dùng (Mật khẩu sha256 của '123456')
...
PRINT N'Khởi tạo Cơ sở Dữ liệu Microsoft SQL Server ql_canhbao_hocvu thành công 100%!';
